...
{% include image.html url="/assets/images/blogovani/2024-02-08-zakladni-konfigurace-blogu/initial_look.JPG" description="Screenshot náhledu blogu bez úprav" %}
...
1. V souboru _config.yml jsem pod github_username přidala proměnnou discord_server a za dvojtečku dodala název mého serveru.
    ...
    {% include image.html url="/assets/images/blogovani/2024-02-08-zakladni-konfigurace-blogu/config_discord.JPG" description="Screenshot _config.yml s proměnnou discord_server" %}
...
{% include image.html url="/assets/images/blogovani/2024-02-08-zakladni-konfigurace-blogu/look_after_config_changes.JPG" description="Screenshot náhledu blogu po základních úpravách" %}
